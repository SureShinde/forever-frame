...
class MageWorx_CustomOptions_Helper_Data extends Mage_Core_Helper_Abstract {
    ...
    public function getDescriptionEditMode() {
        if ($this->isOptionDescriptionEnabled()==2) return Mage::getStoreConfig('mageworx_catalog/customoptions/description_edit_mode2');
    ...
    public function isOptionVariationDescriptionEnabled() {
        return Mage::getStoreConfig('mageworx_catalog/customoptions/option_variation_description_enabled');
    }
    ...
    public function isStoreViewsEnabled() {
        return Mage::getStoreConfigFlag('mageworx_catalog/customoptions/enable_store_views');
    }
